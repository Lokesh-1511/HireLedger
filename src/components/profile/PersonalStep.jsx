  ...
  return (
    <div className="grid" style={{gap:'1rem', maxWidth:620}}>
      <label className="field-group">
        ...
        <input className={fieldErrors.personal?.firstName ? 'invalid' : ''} value={p.firstName} onChange={handle('firstName')} placeholder="Jane" />
      ...
      <label className="field-group">
        ...
        <input className={fieldErrors.personal?.lastName ? 'invalid' : ''} value={p.lastName} onChange={handle('lastName')} placeholder="Doe" />
      ...
      <label className="field-group">
        ...
        <input type="email" className={fieldErrors.personal?.email ? 'invalid' : ''} value={p.email} onChange={handle('email')} placeholder="you@university.edu" />
      ...
      <label className="field-group">
        ...
        <input className={fieldErrors.personal?.phone ? 'invalid' : ''} value={p.phone} onChange={handle('phone')} placeholder="(+1) 555-1234" />
